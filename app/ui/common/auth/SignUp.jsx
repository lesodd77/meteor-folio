              ...
              <div className="px-80 pt-10 pb-0 flex-1">
                <div className="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                  ...
                  <div className="px-10 pt-4 pb-8 bg-transparent rounded-tr-4xl">
                    ...
                    <a href="#" 
                    className="mt-4 block text-sm text-center font-medium text-rose-500 hover:underline focus:outline-none focus:ring-2 focus:ring-cyan-500"> Forgot your password? </a>
                  </div>
                </div>
              </div>
            </div>
